    ...
    return Container(
      ...
      child: Wrap(
        ...
        children: [
          ...
          chip('GRAPH VERTICES ${result.floorDomain.graphVertexCount}', Colors.black87),
          chip('GRAPH EDGES ${result.floorDomain.graphEdgeCount}', Colors.black87),
          chip('T-JUNCTIONS ${result.floorDomain.tJunctionCount}', Colors.black87),
          chip('FACES ${result.floorDomain.graphFaceCount}', Colors.black87),
          chip('FLOOR DOMAIN ${result.floorDomainClosed ? "VALID" : "INVALID"}', result.floorDomainClosed ? Colors.green : Colors.red),
          if (result.floorDomain.sourceEvidenceLimited) chip('SOURCE-EVIDENCE-LIMITED YES', Colors.deepOrange),
